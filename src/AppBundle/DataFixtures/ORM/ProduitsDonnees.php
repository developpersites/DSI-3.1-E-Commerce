...
namespace AppBundle\EcommerceBundle\DataFixtures\ORM;


use AppBundle\EcommerceBundle\Entity\Produits;
...
class ProduitsDonnees extends AbstractFixture implements OrderedFixtureInterface
{
