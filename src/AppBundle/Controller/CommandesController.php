...
class CommandesController extends Controller
{
    ...
    public function facture()
    {
       ...
       // $generator = $this->container->get('security.secure_random');
        ...
        $facturation = $em->getRepository('UtilisateursAdresses')->find($adress['facturation']);
        $livraison = $em->getRepository('UtilisateursAdresses')->find($adress['livraison']);
        $produits = $em->getRepository('Produits')->findArray(array_keys($session->get('panier')));
    ...
    public function prepareCommandeAction(Request $request)
    {
        ...
        if (!$session->has('commande'))
        {
            ...
            $commande = $em->getRepository('Commandes')->find($session->get('commande'));
        }
    ...
    */
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $commande = $em->getRepository('Commandes')->find($id);
       ...
       // $commande->setReference(1); //Service a faire
        ...
        $message = \Swift_Message::newInstance()
            ...
            ->setBody($this->renderView('@Ecommerce/SwiftLayout/validationCommande.html.twig',array('utilisateur' => $commande->getUtilisateur())));
