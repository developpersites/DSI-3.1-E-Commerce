...
class CategoriesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('Admin:categoriesAdmin/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('Admin:categoriesAdmin/new.html.twig', array(
            'category' => $category,
    ...
    public function showAction(Categories $category)
    {
        ...
        return $this->render('Admin:categoriesAdmin/show.html.twig', array(
            'category' => $category,
    ...
    public function editAction(Request $request, Categories $category)
    {
        ...
        return $this->render('Admin:categoriesAdmin/edit.html.twig', array(
            'category' => $category,
